...
def _application_loop(A: float, B: float, C: float, J: float, save_H_matrices: bool, save_submatrices: bool, output_file_path: Path) -> None:
    """"""
...
def _write_outputs_to_file(output_file_path: Path, final_outputs: List[Tuple[int, float, str]], is_j_even: bool) -> None:
    with open(output_file_path, 'a') as f:
        f.write("\n")
...
def app(A: float, B: float, C: float, J: float, IJ: bool, save_H_matrices: bool, save_submatrices: bool, output_file_path: Path) -> None:
